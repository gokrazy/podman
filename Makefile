...
_gokrazy/extrafiles_amd64.tar:
	...
	curl -fsSL https://github.com/mgoltzsche/podman-static/releases/download/v5.8.1/podman-linux-amd64.tar.gz | \
		tar xzv --strip-components=1 -C _gokrazy/extrafiles_amd64/ --exclude README.md
	cd _gokrazy/extrafiles_amd64 && \
		mkdir -p etc/cni/net.d usr/local/lib/cni && \
...
_gokrazy/extrafiles_arm64.tar:
	...
	curl -fsSL https://github.com/mgoltzsche/podman-static/releases/download/v5.8.1/podman-linux-arm64.tar.gz | \
